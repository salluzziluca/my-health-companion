...
const Dashboard = () => {
  ...
  const gradient = theme.palette.mode === 'dark'
    ? `linear-gradient(135deg, ${appColors.darkGradientStart} 0%, ${appColors.darkGradientEnd} 100%)`
    : `linear-gradient(135deg, ${appColors.lightGradientStart} 0%, ${appColors.lightGradientEnd} 100%)`;
